package com.sistema.escuela.modulo.service;

import com.sistema.escuela.modulo.dto.ModuloRequestDto;
import com.sistema.escuela.modulo.repository.ModuloRepository;
...
public class ModuloService {
    ...
    @Transactional
    public ModuloResponseDto eliminarModuloService(ModuloRequestDto moduloRequestDto) {
        int op = 3;
        String v1 = moduloRequestDto.getId_modulo();
